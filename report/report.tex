...
\date{{\begin{center} 28\textsuperscript{th} November 2024 \end{center}} \includegraphics[width=.6\textwidth]{rwth_i12_softw-werkz_en_rgb}}
...
\begin{itemize}
	...
	The GUI is the front-end interface for the user to generate the visualization and animation of the linkage based on the user's input. It uses data obtained from the four-bar linkage model. Moreover, the user must be able to input parameters in the GUI. To solve the optimization problem, we also need to trace the motion of the coupler.

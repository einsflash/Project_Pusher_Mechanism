...
\end{figure}
 ...
 \begin{itemize}
	 ...
	 When the angle between $AD$ and $AB$ is very close to $0^\circ$, $180^\circ$, or $360^\circ$, the programm needs to switch between $C_1$ and $C_2$ for continuity of animation.
 \end{itemize}
